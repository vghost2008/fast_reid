...
def make_parser():
    ...
    parser.add_argument("--save_path", default="datasets", help="Path to save the MOT-ReID dataset")
    parser.add_argument("--mot", default=17, help="MOTChallenge dataset number e.g. 17, 20")
    parser.add_argument("--id_offset", default=0, type=int,help="MOTChallenge dataset number e.g. 17, 20")
