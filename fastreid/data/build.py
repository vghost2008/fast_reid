...
#_root = os.getenv("FASTREID_DATASETS", '/home/wj/ai/mldata1/SportsMOT-2022-4-24/)
_root = "/home/wj/ai/mldata/MOT/fast_reid"
...
def build_reid_train_loader(
    ...
    print(f"Total batch size {total_batch_size}, mini batch size {mini_batch_size}")
